module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c5 = function(receiver, message) {
        		return mk('send', {
        			receiver	: receiver,
        			selector	: message.selector,
        			method 		: '$' + message.selector.replace(/:/g, '$'),
    ...
    function peg$parseArgMessage() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        s4 = peg$parse__();
        if (s4 !== peg$FAILED) {
          s5 = peg$parseTrailingArgMessagePair();
          if (s5 !== peg$FAILED) {
            s4 = [s4, s5];
            s3 = s4;
          } else {
    ...
    function peg$parseTrailingArgMessagePair() {
      var s0, s1, s2, s3, s4, s5;

      s0 = peg$currPos;
      s1 = peg$parseTrailingIdent();
      if (s1 !== peg$FAILED) {
        if (input.charCodeAt(peg$currPos) === 58) {
          s2 = peg$c7;
          peg$currPos++;
    ...
    function peg$parseTrailingIdent() {
      var s0, s1, s2, s3, s4, s5;
